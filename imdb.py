...
class IMDB():
    ...
    def loader(self, batch_size = 4):
        DataLoader(self.train_ds, batch_size=batch_size, shuffle=False, collate_fn=collate_batch)

    def loader(self, batch_size = 4):
        return DataLoader(self.train_ds, batch_size=batch_size, shuffle=False, collate_fn=collate_batch)

    def val_loader(self, batch_size = 4):
        return DataLoader(self.val_ds, batch_size=batch_size, shuffle=False, collate_fn=collate_batch)
